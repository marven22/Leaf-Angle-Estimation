...
IMAGE_PATH = os.path.join(CURRENT_DIRECTORY, "MLAInputImages", "")

CSV_PATH = os.path.join(CURRENT_DIRECTORY, "")

OUTPUT_PATH = os.path.join(CURRENT_DIRECTORY, "originalImageLine", "")
...
if os.path.isfile(CSV_PATH + "Summer_2015-Ames_MLA_bitwise_cropped_outliers.csv"):
        os.remove(CSV_PATH + "Summer_2015-Ames_MLA_bitwise_cropped_outliers.csv")
csvFile = open(CSV_PATH + "Summer_2015-Ames_MLA_bitwise_cropped_outliers.csv", "w")
...
for f in glob.glob(IMAGE_PATH + "*.jpg"):   
    try:
        ...
        flipped, moments = IsImageFlipped(contours, (img2Copy.shape[0], img2Copy.shape[1]))        
